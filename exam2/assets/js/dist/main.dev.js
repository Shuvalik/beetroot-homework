...
$(function () {
      ...
      success: function success(data) {
        data.forEach(function (item) {
          ...
          var htmlStr = {
            ...
            }).text("".concat(pubdate.getDate(), " ").concat(pubdate.toLocaleString("en-US", {
              month: 'short'
            }), " ").concat(pubdate.getFullYear())),
          ...
          case 0:
            ...
            $.ajax({
              ...
              success: function success() {
                toast.success('Your data was successfully sent!');
              },
              error: function error() {
                toast.warning('Form submition faild!');
              }
            });
  ...
  function initMap() {
    var map = L.map('map').setView([49.409091, 26.9476096], 19);
    ...
    L.marker([49.40939, 26.94822], {
      icon: greenIcon,
      title: 'сама смачна кава на районі)'
    }).addTo(map);
  }
  /*call functions */
  ...
  $('form').on('submit', function (e) {
    ...
    var email = $(this).find('#email').val(),
        ...
        msg = "\n            <b> name: </b> ".concat(email, "\n<b> email: </b> ").concat(name);
